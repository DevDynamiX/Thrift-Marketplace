...
import Animated, {Easing, useAnimatedStyle, withTiming, useDerivedValue} from 'react-native-reanimated';
...
const BottomTabs = () => {
    ...
    const [layout, dispatch]  = useReducer((state, action) => [...state, action], []);
    ...
    const AnimatedTabBar = ({state, navigation, descriptors }) => {
        return (
